...
object initload_tfl {
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      .jdbc(jdbcUrl, "tfl_tube_status_new", dbProperties)  // Replace "your_table_name" with your table name
...
//    df_modifiedRows.show(5)
    ...
    df_cleaned.write
      ...
      .saveAsTable("big_datajan2025.TFL_Underground_fulload")  // Specify your database and table name
